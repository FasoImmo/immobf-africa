...
/**
 * Outil de support opérationnel : demande à PawaPay de renvoyer le callback
 * d'un dépôt précis. Utile pour débloquer manuellement une transaction
 * coincée en "pending" lors d'un incident PawaPay (callback non reçu).
 * Réservé aux admins — POST /admin/pawapay/resend-callback/:depositId
 */
