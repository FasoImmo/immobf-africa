 ...
 * + profils vendeurs uniques + hreflang fr/en.
 * Dégradation gracieuse si l'API est indisponible.
 */
...
function urlEntry({ loc, lastmod, changefreq, priority, hreflang = true }) {
  const alternates = hreflang
    ? [
        `    <xhtml:link rel="alternate" hreflang="fr" href="${esc(loc)}"/>`,
